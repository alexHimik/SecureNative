...
void Java_ua_secure_sqlite_SQLiteDatabase_closedb(JNIEnv* env, jobject object, int sqliteHandle) {
...
int Java_ua_secure_sqlite_SQLiteDatabase_opendb(JNIEnv* env, jobject object, jstring fileName) {
